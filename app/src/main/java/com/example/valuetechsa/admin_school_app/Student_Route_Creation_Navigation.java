...
//                                    Log.e("+++",obj.getString("att_month"));
    ...
    private void initiatePopupWindowhawkeyeAlert(String title,String message, String notification_message,final String type) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) Student_Route_Creation_Navigation.this
    ...
    public void reassignBus(){
        ...
        if(tobusnameintoserver.equalsIgnoreCase(getResources().getString(R.string.sj_select_bus))){
            Toast.makeText(Student_Route_Creation_Navigation.this, getResources().getString(R.string.sj_please_select_bus),
                    Toast.LENGTH_LONG).show();
        }
                                ...
                                if(Jobj.getString("responsecode").equals("1"))
                                {
                                    ...
                                    runOnUiThread(new Runnable(){
                                        ...
                                        public void run(){
                                            //update ui here
                                            // display toast here
                                            Toast.makeText(Student_Route_Creation_Navigation.this, getResources().getString(R.string.sj_reassigned_successfully), Toast.LENGTH_SHORT).show();
                                        }
                                    });
