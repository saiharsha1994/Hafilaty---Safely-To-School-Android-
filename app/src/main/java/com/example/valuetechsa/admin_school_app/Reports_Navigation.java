...
public class Reports_Navigation extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterReports adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"ROUTE DISTANCE","VEHICLE DISTANCE","ARRIVAL/DEPARTURE REPORTS","SPEED REPORTS"};
    int Numboftabs =4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports__navigation);
        ...
        TextView navUsername = (TextView) headerView.findViewById(R.id.reportfourheader);
        ...
        TextView TextViewNewFont = new TextView(Reports_Navigation.this);
        TextViewNewFont.setText(getResources().getString(R.string.sj_reportsfour));
        TextViewNewFont.setTextSize(32);
        tfRobo = Typeface.createFromAsset(Reports_Navigation.this.getAssets(), "fonts/ROBOTO-LIGHT.TTF");
        tfAdam = Typeface.createFromAsset(Reports_Navigation.this.getAssets(), "fonts/ADAM.CG PRO.OTF");
        ...
        adapter =  new ViewPagerAdapterReports(getSupportFragmentManager(),Titles,Numboftabs);
    ...
    {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Reports_Navigation.this);
        ...
        alertDialog.setPositiveButton("English", new DialogInterface.OnClickListener()
        {
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                change_language("en");
                dialog.cancel();
                Intent intent = new Intent(Reports_Navigation.this, Leave_Navigation.class);
    ...
    void change_language(String language){
        ...
        Reports_Navigation.this.getResources().updateConfiguration(config,
                Reports_Navigation.this.getResources().getDisplayMetrics());
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            startActivity(new Intent(Reports_Navigation.this, Hawkeye_navigation.class));
            finish();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.reports__navigation, menu);
        return true;
    }
